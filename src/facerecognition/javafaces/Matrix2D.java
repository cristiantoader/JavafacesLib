...
public class Matrix2D extends DenseDoubleMatrix2D {
	private static final long serialVersionUID = 1313267192952979359L;
	...
	/***
	 * Instance of Matrix2D class cannot be put as element in HashList or as a key
	 * in HashMap In the colt library,cern.colt.matrix.DoubleMatrix2D defines
	 * equals and uses Object.hashCode() This is not a good idea since
	 * Object.hashCode() returns JVM assigned integer.
	 */

	public int hashCode() {
		throw new UnsupportedOperationException(
				"cannot use this class instance as hash key");
	}
